...
class Application:
    ...
    def __init__(self, master=None):
        ...
        self.includetext = Label(self.segundoContainer, text="Incluir Texto", font=self.fontePadrao)
        ...
        try:
            with open(file, 'r', encoding='utf-8') as kit:
                ...
                for row in file:
                    ...
                    image = treepoem.generate_barcode(barcode_type=code, data=row[0], options={"includetext": text})
                    image.convert('1').save(f'{local_save}/{row[2]}/{row[1]}.png')
                    current_value += 1
