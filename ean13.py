        ...
        try:
            with open(file, 'r', encoding='utf-8') as kit:
                ...
                for row in file:
                    ...
                    generate('EAN13', row[0], writer=ImageWriter(), output=f'{local_save}/{row[1]}/{row[0]}')
                    # image = treepoem.generate_barcode(barcode_type='ean13', data=row[0], options={"includetext": True})
